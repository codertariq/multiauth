@extends('multiauth::layouts.admin', ['title' => __('multilang::title.change_password')])

@section('content')
<div class="d-flex justify-content-center align-items-center">
    <form class="form-validate-jquery login-form" novalidate="novalidate" method="POST" action="{{ route('admin.password') }}">
        @csrf
        @method('PUT')
